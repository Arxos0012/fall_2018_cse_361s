...
synth_design -top rsrc -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef rsrc.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file rsrc_utilization_synth.rpt -pb rsrc_utilization_synth.pb"
