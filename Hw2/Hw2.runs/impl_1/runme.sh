...
HD_PWD='D:/Vivado Projects/Hw2/Hw2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rsrc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rsrc.tcl -notrace
