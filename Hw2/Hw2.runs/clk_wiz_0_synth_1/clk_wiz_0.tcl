...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir {D:/Vivado Projects/Hw2/Hw2.runs/clk_wiz_0_synth_1} -new_name clk_wiz_0 -ip [get_ips clk_wiz_0]]
...
if { [catch {
  file copy -force {D:/Vivado Projects/Hw2/Hw2.runs/clk_wiz_0_synth_1/clk_wiz_0.dcp} {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.dcp}
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v}
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl}
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v}
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl}
} _RESULT ] } { 
...
if { [catch {
  file rename -force {D:/Vivado Projects/Hw2/Hw2.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.v} {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v}
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force {D:/Vivado Projects/Hw2/Hw2.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.vhdl} {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl}
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force {D:/Vivado Projects/Hw2/Hw2.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.v} {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v}
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force {D:/Vivado Projects/Hw2/Hw2.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.vhdl} {d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl}
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir {D:/Vivado Projects/Hw2/Hw2.ip_user_files/ip/clk_wiz_0}]} {
  catch { 
    file copy -force {{d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v}} {D:/Vivado Projects/Hw2/Hw2.ip_user_files/ip/clk_wiz_0}
  }
}

if {[file isdir {D:/Vivado Projects/Hw2/Hw2.ip_user_files/ip/clk_wiz_0}]} {
  catch { 
    file copy -force {{d:/Vivado Projects/Hw2/Hw2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl}} {D:/Vivado Projects/Hw2/Hw2.ip_user_files/ip/clk_wiz_0}
  }
}
